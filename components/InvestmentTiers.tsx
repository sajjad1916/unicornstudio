  ...
  const packages = [
    {
      tag: "Quick Launch",
      name: "Website",
      outcome: "A high-converting digital presence that turns visitors into customers",
      investment: "4.5K",
      timeline: "2-3 weeks",
      ideal: "Startups needing market validation",
      delivers: [
    ...
    },
    {
      tag: "Most Chosen",
      name: "MVP",
      outcome: "Transform your validated idea into a working product people actually use",
      investment: "12K",
      timeline: "4-6 weeks",
      ideal: "Founders ready to launch",
      delivers: [
        "Market validation & strategy",
        "Complete brand foundation",
        "User-tested UX/UI design",
    ...
    },
    {
      ...
      name: "Mobile App",
      outcome: "iOS & Android apps that users love, with backend infrastructure that scales",
      investment: "18K",
      timeline: "6-8 weeks",
      ideal: "Products requiring mobile-first",
      delivers: [
    ...
    },
    {
      tag: "Full Stack",
      name: "Complete SaaS",
      outcome: "Enterprise-grade SaaS platform ready to scale from day one",
      investment: "25K",
      timeline: "8-12 weeks",
      ideal: "Teams building for scale",
      delivers: [
