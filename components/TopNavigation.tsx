        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a href="#hero" className="flex items-center gap-2 group">
              ...
              <span className="text-lg font-bold text-gray-900">Unicorn Studio</span>
            </a>

            {/* CTA Button */}
            <a
              href="#contact"
              className="px-6 py-2.5 bg-blue-600 text-white rounded-xl font-semibold text-sm hover:bg-blue-700 hover:shadow-lg transition-all duration-300 hover:scale-105"
            >
              Book a Call
            </a>
          </div>
