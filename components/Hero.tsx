...
export default function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-white pt-16 sm:pt-0">
      ...
      <div className="max-w-7xl mx-auto text-center relative z-10 w-full">
        ...
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight tracking-tight px-2">
          Turn your idea into
          <br />
        ...
        {/* Subheading */}
        <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 sm:mb-10 max-w-3xl mx-auto leading-relaxed font-light px-2">
        ...
        {/* CTA Buttons */}
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-12 sm:mb-16 px-2 w-full max-w-md sm:max-w-none mx-auto">
          <a
            href="#contact"
            className="group relative w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 text-white rounded-lg font-semibold text-sm sm:text-base overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/25 text-center"
          >
          ...
          <a
            href="#portfolio"
            className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-white text-gray-900 rounded-lg font-semibold text-sm sm:text-base border-2 border-gray-200 hover:border-blue-600 hover:shadow-lg transition-all duration-300 text-center"
          >
            View Our Work
          </a>
        </div>
