    ...
    <section id="services" className="py-32 px-4 sm:px-6 lg:px-8 bg-white">
      <div className="w-full max-w-[50%] mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            <h2 className="text-base font-bold text-gray-900 mb-4 tracking-tight leading-tight">
            ...
            <div className="space-y-3">
              {services.map((service, index) => (
                <div key={index} className="flex items-center gap-2 group">
                  <span className="text-blue-600 text-xs">{service.icon}</span>
                  <span className="text-sm text-gray-900 font-light group-hover:text-blue-600 transition-colors duration-300">
                    {service.name}
                  </span>
                  {service.badges && (
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gray-50 p-4 rounded-xl min-h-[100px] transition-all duration-300">
